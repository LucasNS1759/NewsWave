...
const ClimaActual = () => {
  ...
  return (
    <div className="card max-w-sm max-h-sm  h-3/4 border w-3/4 xl:w-full text-black rounded-md xl:mr-2 bg-slate-200">
      ...
      <div className="text-md pt-1 pb-1 px-4">
        ...
        <h2 className="mt-8 text-base font-medium">
          Actualizado a las {new Date().getHours()}:{new Date().getMinutes()}{" "}
        </h2>
      </div>
    </div>
  );
