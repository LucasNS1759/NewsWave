...
const ClimaTarjeta = () => {
  ...
  //estado donde se muestra el clima dia lugar y fecha  actual seleccionado
  const [climaActual, setClimaActual] = useState("");
  //////////////////////////////////////////////////////

  // tiene toda la data del clima por hora
  const [weatherData, setWeatherData] = useState(null);
  ///////////////////////////////////////////

  // array donde se muestra solo los datos necesarios para mostrar una previsualizacion del pronostico extendido se muestra en el recueadro derecho
  const [pronosticoCorto, setpronosticoCorto] = useState([]);
  ////////////////////////////////////////////////////////////////

  //estado para que cargue toda la data antes de poder mostrarse (evita un bug)
  ...
  const getClima =async () => {
    try {
      const response = await axios.get(
        `http://localhost:3001/clima/extendido?latitude=${
...
console.log(response.data)
  ...
  console.log(useClimaQuery.data)
      ...
      {!useClimaQuery.isLoading &&  useClimaQuery.data ? (
        <div className="w-full mt-16 lg:mt-64 justify-center container mx-auto">
          ...
          <div className="flex  w-full ">
            ...
            <div
              className=" flex rounded-lg bg-auto"
              ...
              <div className="rounded-lg py-6 pl-12 xl:pl-28 xl:pr-28 pr-12 w-full bg-blue-400 opacity-90 text-white">
                <div className="mb-20">
                  <h2 className="font-bold text-3xl leading-none pb-1">
                    {climaActual && !carga ? climaActual?.dia : pronosticoCorto[0]?.dia}
                  </h2>
