...
const HomeNoticias = () => {
  ...
  const useNoticiasQuery = useQuery({
    queryKey: ["noticiasQuery"],
    queryFn: getUltimasNoticias,
  });
  console.log(useNoticiasQuery.data)
    ...
    <div className="max-w-screen-lg mx-auto">
      ...
      {loading ? (
        ...
        <main className="mt-28">
          ...
          {!loading &&
            noticias &&
            Object.entries(useNoticiasQuery.data &&  noticias).map((noticia, index) => {
              return (
                <NoticiasGrupoDeTres
                  key={index}
