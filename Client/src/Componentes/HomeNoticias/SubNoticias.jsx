const SubNoticias = ({ category, key }) => {
  return (
    <div
      key={key}
      className="rounded w-full flex flex-col md:flex-row mb-10 text-gray-800"
    >
      <img
        src={
      ...
      />
      <a href={category && category?.url} target="_blank" rel={"noreferrer"}>
        <div className="bg-white rounded px-4">
          <span className=" font-bold text-sm hidden md:block"> </span>
